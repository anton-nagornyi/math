...
it("array", () =>
{
    ...
    expect(Mathf.vector.distance(a, b)).toBeCloseTo(49.295);
});
...
it("numbers2", () =>
{
    ...
    expect(Mathf.vector.distance(a, b)).toBeCloseTo(20.1246);
});
...
it("numbers3", () =>
{
    ...
    expect(Mathf.vector.distance(a, b)).toBeCloseTo(33.6749);
});
